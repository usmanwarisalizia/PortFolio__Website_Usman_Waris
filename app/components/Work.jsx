        ...
        <>
            <motion.div
                ...
                <motion.p
                    ...
                    Welocme to my web development portfolio! Explore a collection of projects
                ...
                border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-[#fcf4ff] duration-500 dark:text-white dark:hover:bg-darkHover dark:border-white
                ">
                    Show more <Image src={isDarkMode ? assets.right_arrow_white : assets.right_arrow} alt="Right arrow" className="w-4" />
                </motion.a>
            </motion.div>
        </>
    )
