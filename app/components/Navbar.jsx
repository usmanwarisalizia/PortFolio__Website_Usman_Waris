...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
    ...
    return (
        <>
            ...
            flex items-center justify-between z-50 ${isScroll ? " bg-opacity-50 backdrop-blur-lg bg-white/30 dark:bg-darkTheme/30 shadow-sm z-50 dark:darkTheme dark:shadow-white/20" : ""}`}>
                <a href="#top">
                ...
                rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark border dark:border-white/50 dark:bg-none"}`}
                >
